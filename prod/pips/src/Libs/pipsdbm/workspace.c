/*
  ...
  $Id: workspace.c 23065 2016-03-02 09:05:50Z coelho $
...
// FI: I would like to export MD_DATABASE via pipsdbm-local.h
// for use in workspace-util
#define MD_DATABASE		"database"

/* returns an allocated string. */
string db_get_workspace_directory_name(const char* name)
{
    return strdup(concatenate("./", name, "." MD_DATABASE, NULL)); 
}
...
// "Warnings" should be defined here... but for cycle between libraries?
