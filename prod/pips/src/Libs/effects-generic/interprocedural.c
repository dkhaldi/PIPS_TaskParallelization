/*
  ...
  $Id: interprocedural.c 23268 2016-11-02 08:57:16Z coelho $
...
/* HMMM... INDEED, THIS SHOULD NOT BE HERE...
 */
#include "pips-libs.h"
...
static list backward_translation_of_points_to_formal_context_effect(
  entity callee,  list real_args,  effect eff)
{
...
static list backward_translation_of_points_to_formal_context_effect(
  _UNUSED_ entity callee, _UNUSED_ list real_args, _UNUSED_ effect eff)
{
