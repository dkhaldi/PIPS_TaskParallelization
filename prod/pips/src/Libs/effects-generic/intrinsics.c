/*
  ...
  $Id: intrinsics.c 23065 2016-03-02 09:05:50Z coelho $
...
static IntrinsicDescriptor IntrinsicEffectsDescriptorTable[] = {
 ...
 /* ISO 6.5.11 bitwise exclusive OR operator */
  ...
  /* The effets are wrong for most of these intrinsics functions */
  ...
  {MKTIME_FUNCTION_NAME,                   no_write_effects},
  // Side effect
  ...
  {GMTIME_FUNCTION_NAME,                   no_write_effects},
  {LOCALTIME_FUNCTION_NAME,                no_write_effects},
  // Side effect
  {GMTIME_R_FUNCTION_NAME,                 no_write_effects},
  // Side effect
  {LOCALTIME_R_FUNCTION_NAME,              no_write_effects},
  // Side effect
  {ASCTIME_FUNCTION_NAME,                  no_write_effects},
  // Side effect
...
/**
 * NL: the name of the function is certainly bad chosen
 *     because it also compute side effects (that can be write)
 */
static list
