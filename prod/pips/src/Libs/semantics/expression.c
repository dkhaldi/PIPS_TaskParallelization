/*
  ...
  $Id: expression.c 23163 2016-07-27 21:00:10Z irigoin $
    ...
    bool is_internal)
{
  ...
  if(ENTITY_DEREFERENCING_P(op)) {
    ...
    if (syntax_reference_p(s1)) {
      ...
      entity a1 = reference_to_address_entity(r1);
			      ...
			      bool is_internal)
{
  ...
  if( (basic_tag(bv)==basic_tag(be))
    ...
    semantics_user_warning("Implicit type coercion between %s variable and %s "
