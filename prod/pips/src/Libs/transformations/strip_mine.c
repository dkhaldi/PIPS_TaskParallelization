/*
  ...
  $Id: strip_mine.c 23065 2016-03-02 09:05:50Z coelho $
...
#include "transformations.h" // selected_loop_p in "interactive_loop_transformation.c"
...
statement loop_strip_mine(statement loop_statement,
                          int chunk_size, int chunk_number)
{
