/*
  ...
  $Id: interchange.c 23065 2016-03-02 09:05:50Z coelho $
...
#include "phases.h"
#ifdef BUILDER_LOOP_INTERCHANGE
...
// obsolete linear librarices...
#include "matrice.h" // needed for sparse_sc
#include "sparse_sc.h" // sys_matrice_index / matrice_index_sys
...
#include "conversion.h" // various utils
#include "transformations.h" // interactive_loop_transformation
...
bool loop_interchange(const string module_name)
{
...
#endif // BUILDER_LOOP_INTERCHANGE
