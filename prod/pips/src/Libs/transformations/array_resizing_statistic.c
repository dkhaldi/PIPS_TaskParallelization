/*
  ...
  $Id: array_resizing_statistic.c 23065 2016-03-02 09:05:50Z coelho $
...
#include "phases.h"
#ifdef BUILDER_ARRAY_RESIZING_STATISTIC

#ifdef HAVE_CONFIG_H
    #include "pips_config.h"
#endif
/*
  This phase computes the number of pointer-type A(1) and assumed-size A(*)
  array declarators in one program.
  There are two cases: these unnormalized declarations are formal array
  parameters or not
*/
...
bool array_resizing_statistic(const string module_name)
{
...
#endif // BUILDER_ARRAY_RESIZING_STATISTIC
