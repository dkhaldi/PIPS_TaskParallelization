/*
  ...
  $Id: partial_redundancy_elimination.c 23065 2016-03-02 09:05:50Z coelho $
...
#include "phases.h"
#ifdef BUILDER_PARTIAL_REDUNDANCY_ELIMINATION
...
#include "expressions.h" // stmt_prec
...
#include "graph.h"
#include "ricedg.h" // sc_restricted_to_variables_transitive_closure
...
static void initialize_partial_redundancy_elimination_statistics(void)
{
...
static void display_partial_redundancy_elimination_statistics(void)
{
 ...
 */
bool partial_redundancy_elimination(const string module_name)
{
...
#endif // BUILDER_PARTIAL_REDUNDANCY_ELIMINATION
