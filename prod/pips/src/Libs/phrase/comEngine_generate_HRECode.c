/*
  ...
  $Id: comEngine_generate_HRECode.c 23065 2016-03-02 09:05:50Z coelho $
 ...
 */
list make_loop_lStats_HRE(
  statement stat, entity transferSize,
  statement innerStat, entity newOuterInd,
  _UNUSED_ list lSupportedRef, _UNUSED_ hash_table htOffset,
 ...
 */
statement comEngine_generate_HRECode(
