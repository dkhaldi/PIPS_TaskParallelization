# $Id: pipsrc.sh 23065 2016-03-02 09:05:50Z coelho $
#
...
set newgen_dir=/projects/Newgen

# the root location of where to find the newgen to use 
setenv NEWGEN_ROOT ${newgen_dir}/prod

# PATH update
setenv PATH "${PATH}:${NEWGEN_ROOT}/bin:${NEWGEN_ROOT}/bin/${PIPS_ARCH}"
...
set linear_dir=/projects/C3/Linear

# the version to use
setenv LINEAR_ROOT ${linear_dir}/prod
...
set eole_dir=/projects/Eole

setenv EOLE_ROOT ${eole_dir}/prod

setenv PATH "${PATH}:${EOLE_ROOT}/bin/${PIPS_ARCH}"
...
set pips_dir=/projects/Pips

setenv PIPS_ROOT "${pips_dir}/prod"

# man pages?
set MANPATH="${MANPATH}:${PIPS_ROOT}/man"

setenv PATH "${PATH}:${PIPS_ROOT}/bin:${PIPS_ROOT}/bin/${PIPS_ARCH}"

# to get some determinism...

setenv PIPS_CPP 'gcc -E -C'
setenv PIPS_FPP 'gcc -E -C'
...
test ${uname_s} = Linux && \
setenv PIPS_PING "ping -c 1"

# under solaris basename is refexpr based.
test ${uname_s} = SunOS && \
setenv PIPS_BASENAME "/usr/ucb/basename"

test ${uname_s} = Linux && \
setenv PIPS_FLINT "g77 -c -Wall -Wimplicit"

test ${uname_s} = Linux && \
setenv PIPS_MAKE "make"

test ${uname_s} = FreeBSD && \
setenv PIPS_MAKE "gmake"
...
setenv X11_ROOT "$OPENWINHOME"

test ${uname_s} = Linux && \
setenv X11_ROOT "/usr/X11"
...
setenv EXTERN_ROOT "${pips_dir}/Externals"

setenv PATH "${PATH}:${EXTERN_ROOT}/Share:${EXTERN_ROOT}/Utils"
setenv PATH "${PATH}:${EXTERN_ROOT}/Bin/${PIPS_ARCH}"
