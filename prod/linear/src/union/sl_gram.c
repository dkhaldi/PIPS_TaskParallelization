...
{
       0,    77,    77,    81,    88,    93,    96,    97,   100,   107,
     108,   111,   115,   123,   134,   135,   136,   139,   143,   156,
     161,   162,   162,   163,   166,   178,   190,   201,   216,   222,
     230,   238,   246,   254,   263,   265,   269,   270,   274,   302,
     303
};
#endif
...
static const char *const yytname[] =
{
  ...
  "multi_membre", "fin_mult_membre", "virg_opt", YY_NULL
};
#endif
...
#line 167 "sl_gram.y"
    {
     ...
     vect_add_elem(&(eq->vecteur), (Variable) (yyvsp[(2) - (2)].Variable),value_mult(fac,(yyvsp[(1) - (2)].Value)));
     /* duplication du couple (ident,const) de la combinaison lineaire
        traitee*/ 
     if (operat) vect_add_elem(&cp,(Variable) (yyvsp[(2) - (2)].Variable),
...
#line 179 "sl_gram.y"
    {
       Value v = value_mult(fac,(yyvsp[(1) - (1)].Value));
            if (cote==DROIT)
            {
...
#line 191 "sl_gram.y"
    {
     ...
     if (operat) vect_add_elem(&cp,(Variable) (yyvsp[(1) - (1)].Variable),value_uminus(fac));
   }
    break;
