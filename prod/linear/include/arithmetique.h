...
/* Modify src/Libs/arithmetique/arithmetique-local.h instead, to add your own modifications. */
...
/*
  ...
  $Id: arithmetique-local.h 1641 2016-03-02 08:20:19Z coelho $
...
/* abs.c */
extern Value abs_ofl_ctrl(Value /*i*/, int /*ofl_ctrl*/);
extern Value absval_ofl(Value /*i*/);
extern Value absval(Value /*i*/);
/* divide.c */
extern Value divide_fast(Value /*a*/, Value /*b*/);
extern Value divide_slow(Value /*a*/, Value /*b*/);
/* exp.c */
extern Value exponentiate(Value /*x*/, int /*n*/);
/* modulo.c */
extern Value modulo_fast(Value /*a*/, Value /*b*/);
/* pgcd.c */
extern Value pgcd_slow(Value /*a*/, Value /*b*/);
extern Value pgcd_fast(Value /*a*/, Value /*b*/);
extern Value pgcd_interne(Value /*a*/, Value /*b*/);
extern Value gcd_subtract(Value /*a*/, Value /*b*/);
extern Value vecteur_bezout(Value /*u*/[], Value /*v*/[], int /*l*/);
extern Value bezout(Value /*a*/, Value /*b*/, Value */*x*/, Value */*y*/);
extern Value bezout_grl(Value /*a*/, Value /*b*/, Value */*x*/, Value */*y*/);
/* ppcm.c */
extern Value ppcm(Value /*i*/, Value /*j*/);
/* io.c */
extern void print_Value(Value /*v*/);
extern void fprint_Value(FILE */*f*/, Value /*v*/);
extern void fprint_string_Value(FILE */*f*/, char */*blah*/, Value /*v*/);
extern void sprint_Value(char */*s*/, Value /*v*/);
extern int fscan_Value(FILE */*f*/, Value */*pv*/);
extern int scan_Value(Value */*pv*/);
extern int sscan_Value(char */*s*/, Value */*pv*/);
extern char *Value_to_string(Value /*v*/);
/* errors.c */
extern char const *get_exception_name(const linear_exception_t /*exception*/);
extern void linear_reset_error_counters(void);
extern unsigned int linear_error_count(void);
extern void linear_get_error_counts(unsigned int */*poe*/, unsigned int */*pse*/, unsigned int */*pme*/);
extern linear_exception_t the_last_just_thrown_exception;
extern void set_exception_callbacks(exception_callback_t /*push*/, exception_callback_t /*pop*/);
extern int linear_number_of_exception_thrown;
extern void dump_exception_stack_to_file(FILE */*f*/);
extern void dump_exception_stack(void);
extern jmp_buf *linear_push_exception_on_stack(const int /*what*/, const char */*function*/, const char */*file*/, const int /*line*/);
extern jmp_buf *push_exception_on_stack(const int /*what*/, const char */*function*/, const char */*file*/, const int /*line*/);
extern void linear_pop_exception_from_stack(const int /*what*/, const char */*function*/, const char */*file*/, const int /*line*/);
extern void pop_exception_from_stack(const int /*what*/, const char */*function*/, const char */*file*/, const int /*line*/);
extern void linear_throw_exception(const int /*what*/, const char */*function*/, const char */*file*/, const int /*line*/);
extern void throw_exception(const int /*what*/, const char */*function*/, const char */*file*/, const int /*line*/);
extern void linear_initialize_exception_stack(unsigned int /*verbose_exceptions*/, exception_callback_t /*push*/, exception_callback_t /*pop*/);
extern bool linear_with_gmp(void);
extern bool linear_require_gmp(void);
extern bool linear_use_gmp(void);
extern void set_timeout_callback(timeout_callback_f /*callback*/);
extern void push_timeout(const unsigned int /*delay*/, const char */*funcname*/, const char */*filename*/, const int /*lineno*/);
extern bool push_timeout_env(const char */*env*/, const char */*funcname*/, const char */*filename*/, const int /*lineno*/);
extern void pop_timeout(const char */*funcname*/, const char */*filename*/, const int /*lineno*/);
extern void pop_timeout_env(const char */*env*/, const char */*funcname*/, const char */*filename*/, const int /*lineno*/);
/* value.c */
extern int value_comparison(Value /*v1*/, Value /*v2*/);
