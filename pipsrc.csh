...
setenv NEWGEN_SVN https://scm.cri.ensmp.fr/svn/newgen
setenv LINEAR_SVN https://scm.cri.ensmp.fr/svn/linear
setenv PIPS_SVN https://scm.cri.ensmp.fr/svn/pips

# production directory
set prod=/home/dounia/MYPIPS/prod
...
# fix path
setenv PATH $prod/pips/bin:$prod/pips/utils:$prod/newgen/bin:$PATH
