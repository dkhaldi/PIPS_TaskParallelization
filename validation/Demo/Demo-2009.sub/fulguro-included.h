...
// these declarations are needed for clang syntax check:
extern void flgr_free(void *);
extern void flgr_backtrace_print(void);
extern void flgr2d_get_data_vector_no_norm_fgUINT16(FLGR_Data2D *, int, int, FLGR_Vector *);
extern void flgr2d_get_data_vector_fgUINT16(FLGR_Data2D *, int, int, FLGR_Vector *);
extern void flgr2d_fill_nhb_even_rows_fgUINT16(FLGR_Data2D *, FLGR_Data2D *);
extern void flgr2d_draw_point_fgUINT16(FLGR_Data2D *, int, int, FLGR_Vector *);
